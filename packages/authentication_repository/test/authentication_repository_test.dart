...
void main() {
  ...
  group('AuthenticationRepository', () {
    ...
    group('logInWithEmailAndPassword', () {
      test('thows AssertionError when email is null', () {
        expect(
            () => authenticationRepository.logInWithEmailAndPassword(
                email: null, password: password),
            throwsAssertionError);
      });
      test('thows AssertionError when password is null', () {
        expect(
            () => authenticationRepository.logInWithEmailAndPassword(
      ...
      test(
          'throws LogInWithEmailAndPasswordFailure when'
          'signInWithEmailAndPassword throws', () {
    ...
    group('user', () {
      ...
      test('emits User when firebase user is not null', () async {
        ...
        await expectLater(
            authenticationRepository.user, emitsInOrder(const <User>[user]));
      });
    });
  });
}
